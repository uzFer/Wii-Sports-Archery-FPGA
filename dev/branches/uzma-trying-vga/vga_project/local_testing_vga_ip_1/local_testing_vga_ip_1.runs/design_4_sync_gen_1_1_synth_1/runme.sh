...
HD_PWD='Y:/vga_project/local_testing_vga_ip_1/local_testing_vga_ip_1.runs/design_4_sync_gen_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_4_sync_gen_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_4_sync_gen_1_1.tcl
