...
proc update_PARAM_VALUE.EXT_RGB_WIDTH { PARAM_VALUE.EXT_RGB_WIDTH } {
	# Procedure called to update EXT_RGB_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.EXT_RGB_WIDTH { PARAM_VALUE.EXT_RGB_WIDTH } {
	# Procedure called to validate EXT_RGB_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.EXT_RGB_WIDTH { MODELPARAM_VALUE.EXT_RGB_WIDTH PARAM_VALUE.EXT_RGB_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.EXT_RGB_WIDTH}] ${MODELPARAM_VALUE.EXT_RGB_WIDTH}
}
