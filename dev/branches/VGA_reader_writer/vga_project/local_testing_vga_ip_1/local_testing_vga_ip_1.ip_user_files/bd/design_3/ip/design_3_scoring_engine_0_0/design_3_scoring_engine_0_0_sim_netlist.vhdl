...
--               Y:/vga_project/local_testing_vga_ip_1/local_testing_vga_ip_1.srcs/sources_1/bd/design_3/ip/design_3_scoring_engine_0_0/design_3_scoring_engine_0_0_sim_netlist.vhdl
...
entity design_3_scoring_engine_0_0_scoring_engine is
  port (
  ...
  attribute ORIG_REF_NAME of design_3_scoring_engine_0_0_scoring_engine : entity is "scoring_engine";
end design_3_scoring_engine_0_0_scoring_engine;

architecture STRUCTURE of design_3_scoring_engine_0_0_scoring_engine is
...
\score[3]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\score[3]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_3_scoring_engine_0_0 is
  port (
    clk : in STD_LOGIC;
    resetn : in STD_LOGIC;
    trig_calc : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_3_scoring_engine_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_3_scoring_engine_0_0 : entity is "design_3_scoring_engine_0_0,scoring_engine,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_3_scoring_engine_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_3_scoring_engine_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_3_scoring_engine_0_0 : entity is "scoring_engine,Vivado 2018.3";
end design_3_scoring_engine_0_0;

architecture STRUCTURE of design_3_scoring_engine_0_0 is
...
begin
inst: entity work.design_3_scoring_engine_0_0_scoring_engine
     port map (
      clk => clk,
