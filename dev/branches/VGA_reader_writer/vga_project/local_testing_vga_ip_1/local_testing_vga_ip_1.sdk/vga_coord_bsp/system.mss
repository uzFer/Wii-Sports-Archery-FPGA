...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = framewriter
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = framewriter_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = axi_gpio_uart_input
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = axi_gpio_uart_output
END
