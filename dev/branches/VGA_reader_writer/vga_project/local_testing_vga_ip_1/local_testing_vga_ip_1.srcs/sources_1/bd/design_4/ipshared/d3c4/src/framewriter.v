...
//    wire [3:0] ones_val = (axi_framewriter_myScore >= 10) ? 4'd0 : axi_framewriter_myScore[3:0];
   wire [3:0] ones_val = (axi_framewriter_myScore >= 10) ? 4'd0 : 4'd6; // testing
...
//   wire [31:0] pipe_dist_sq;
   ...
   if (!axi_aresetn) begin
       ...
       if (current_state == WAIT) begin
           ...
           pipe_dist_sq <= pipe_dx_sq + pipe_dx_sq; 
       end
...
//      else                                     target_color = TURQUOISE;
       ...
       case (score_latch)
           ...
           4'd12:   final_color = target_color; // Logic for score/digits handled in next step
