...
HD_PWD='y:/framewriter_ip/managed_ip_project/managed_ip_project.tmp/framewriter_v1_project/framewriter_v1_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log framewriter_v1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source framewriter_v1.tcl
