...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of sync_gen_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins sync_gen_0/S00_AXI]
	connect_bd_net [get_bd_pins sync_gen_0/s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins sync_gen_0/s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to sync_gen_v1_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/sync_gen_v1_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_sync_gen_0_S00_AXI_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/sync_gen_v1_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "sync_gen_v1_hw_${i}"
