...
HD_PWD='Y:/vga_project/local_testing_vga_ip_1/local_testing_vga_ip_1.runs/design_3_axi_gpio_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_axi_gpio_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_axi_gpio_3_0.tcl
