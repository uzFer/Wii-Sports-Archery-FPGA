...
simulate()
{
  xsim design_4 -key {Behavioral:sim_1:Functional:design_4} -tclbatch cmd.tcl -protoinst "protoinst_files/design_4.protoinst" -protoinst "protoinst_files/design_3.protoinst" -protoinst "protoinst_files/design_2.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb design_4.wdb xsim.dir)
