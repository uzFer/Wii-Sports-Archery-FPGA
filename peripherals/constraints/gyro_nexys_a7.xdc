...
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports {gyroscope_enable} ]; # gyroscope_enable
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports {calibrate} ]; # calibrate
...
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports {calibration_done}];
