...
proc update_PARAM_VALUE.BRAM_WE_WIDTH { PARAM_VALUE.BRAM_WE_WIDTH } {
	# Procedure called to update BRAM_WE_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BRAM_WE_WIDTH { PARAM_VALUE.BRAM_WE_WIDTH } {
	# Procedure called to validate BRAM_WE_WIDTH
	return true
}

proc update_PARAM_VALUE.SLAVE_REG_WIDTH { PARAM_VALUE.SLAVE_REG_WIDTH } {
	# Procedure called to update SLAVE_REG_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SLAVE_REG_WIDTH { PARAM_VALUE.SLAVE_REG_WIDTH } {
	# Procedure called to validate SLAVE_REG_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.SLAVE_REG_WIDTH { MODELPARAM_VALUE.SLAVE_REG_WIDTH PARAM_VALUE.SLAVE_REG_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SLAVE_REG_WIDTH}] ${MODELPARAM_VALUE.SLAVE_REG_WIDTH}
}
...
proc update_MODELPARAM_VALUE.BRAM_WE_WIDTH { MODELPARAM_VALUE.BRAM_WE_WIDTH PARAM_VALUE.BRAM_WE_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BRAM_WE_WIDTH}] ${MODELPARAM_VALUE.BRAM_WE_WIDTH}
}
