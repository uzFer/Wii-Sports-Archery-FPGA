`timescale 1 ns / 1 ps
	...
	(
        ...
        input wire [SLAVE_REG_WIDTH-1:0] axi_framewriter_myScore, // TODO: logic for writing number
        input wire [SLAVE_REG_WIDTH-1:0] axi_framewriter_oppScore, 

        // TODO: tb for writing 
            // (1) coordinate input from AXI to correct address location in BRAM. 
            // (2) ^same, but scoring 
            // (future) test these with AXI VIP

        // BRAM port A wires
        // TODO: look into how to connect it in a block diagram - with BRAM / BRAM controller
