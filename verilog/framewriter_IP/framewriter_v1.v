...
`timescale 1 ns / 1 ps
	...
	(
        ...
        wire [C_S00_AXI_DATA_WIDTH-1:0] axi_framewriter_reg2; 
        wire [C_S00_AXI_DATA_WIDTH-1:0] axi_framewriter_reg3; 
        wire [C_S00_AXI_DATA_WIDTH-1:0] axi_framewriter_reg4; 
        wire [C_S00_AXI_DATA_WIDTH-1:0] axi_framewriter_reg5;
        wire [C_S00_AXI_DATA_WIDTH-1:0] axi_framewriter_reg6; 
        wire [C_S00_AXI_DATA_WIDTH-1:0] axi_framewriter_reg7;	
...
//        .axi_framewriter_oppScore(axi_framewriter_oppScore[SLAVE_REG_WIDTH-1:0]),
        ...
        .game_state_archery_fsm(game_state_archery_fsm), // debug
        .left_btn(left_btn),
        .right_btn(right_btn),
        // Physics Engine Data
...
//        .axi_framewriter_oppScore(axi_framewriter_oppScore[SLAVE_REG_WIDTH-1:0]), // testing
        ...
        // prevent optimization signals
        .dbg_out_pixel_to_write(pixel_to_write),
        .dbg_out_is_crosshair_pixel(is_crosshair_pixel),
        .dbg_out_is_target_pixel(is_target_pixel),
        .dbg_out_is_square_pixel(is_square_pixel),
